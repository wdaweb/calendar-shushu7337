...
<body class="d-flex justify-content-around align-items-center vw-100 flex-column" style="height: 100vh;">
<form action="save_invoice.php" method="post"> 
<div class="card my-5 mx-auto shadow alert-info border-warning" style="height: 300px;width: 500px;">
    <div class="row no-gutters">
      <div class="col-md-4">
        <img src="https://picsum.photos/90/300">
      </div>
      <div class="col-md-8">
